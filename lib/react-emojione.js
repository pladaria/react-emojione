    ...
    _createClass(Emojify, [{
        ...
        value: function traverse(children, options) {
            ...
            return _react2.default.Children.map(children, function (child) {
                if (_react2.default.isValidElement()) {
                    return _react2.default.cloneElement.apply(_react2.default, [child, {}].concat(_toConsumableArray(_this2.traverse(child.props.children, options))));
                }
